...
const mdTransitionAnimation = (_, opts) => {
  ...
  const ionPageElement = (0,_index2_js__WEBPACK_IMPORTED_MODULE_1__.g)(enteringEl);
  const enteringToolbarEle = ionPageElement.querySelector('ion-toolbar');
  const rootTransition = (0,_animation_js__WEBPACK_IMPORTED_MODULE_0__.c)();
  ...
  if (leavingEl && backDirection) {
    ...
    const leavingPage = (0,_animation_js__WEBPACK_IMPORTED_MODULE_0__.c)();
    leavingPage.addElement((0,_index2_js__WEBPACK_IMPORTED_MODULE_1__.g)(leavingEl)).onFinish(currentStep => {
